		...
		<RouterLink
			classList={{
				...
				"text-base tracking-tight transition-[text-decoration-color] inline-flex items-center justify-center space-x-2 text-decoration text-decoration-underline text-decoration-transparent":
					true,
				"text-blue11 hover:text-decoration-blue4 focus:text-decoration-blue8":
					local.variant === "blue",
				"text-gray11 hover:text-decoration-gray4 focus:text-decoration-gray8":
					local.variant === "subtle",
