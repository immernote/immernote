	...
	return (
		<Comp
			className={clsx({
				...
				"bg-amber3 hover:bg-amber4 focus:bg-amber5 text-amber11": (!state || state === "idle") && variant === "amber",
				"bg-gray3 hover:bg-gray4 focus:bg-gray5 text-gray11": (!state || state === "idle") && variant === "gray",
				"bg-blue3 hover:bg-blue4 focus:bg-blue5 text-blue11": (!state || state === "idle") && variant === "blue",
				"bg-transparent hover:bg-gray3 focus:bg-gray4 text-gray12": (!state || state === "idle") && variant === "ghost",
				"bg-red3 hover:bg-red4 focus:bg-red5 text-red11": (!state || state === "idle") && variant === "red",
			})}
